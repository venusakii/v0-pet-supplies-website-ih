...
const products = [
  ...
  },
  {
    ...
    expertReview: {
      ...
      safety: 4.8,
      summary:
        "A comprehensive grooming kit that brings professional-quality tools to home use. The quality of the tools and the complete nature of the kit make it an excellent investment for small dog owners.",
    },
    amazonLink: "https://amazon.com/dp/example404",
  },
  {
    id: 8,
    ...
    expertReview: {
      ...
      safety: 4.7,
      summary:
        "These collapsible bowls are perfect for active dog owners who travel frequently. The convenience and portability are excellent, making them a practical addition to any travel kit.",
    },
    amazonLink: "https://amazon.com/dp/example505",
  },
  {
    id: 9,
    ...
    cons: ["More expensive than single flavor", "Some treats may crumble", "Strong smell"],
    expertReview: {
      overall: 4.6,
      quality: 4.7,
      value: 4.5,
      ...
      safety: 4.9,
      summary:
        "This variety pack offers excellent options for training small dogs. The natural ingredients and perfect size make them ideal for training sessions. The variety helps keep dogs motivated during training.",
    },
    amazonLink: "https://amazon.com/dp/example606",
  },
]
