...
const products = [
  ...
  },
  {
    ...
    category: "Harnesses",
    description:
      "Comfortable, breathable harness perfect for small breeds with matching leash and waste bag dispenser.",
    features: ["Breathable Mesh", "Adjustable Fit", "Reflective Strips", "Waste Bags Included"],
  },
  {
    id: 3,
    ...
    badge: "New",
    category: "Toys",
    description: "Set of 3 puzzle toys designed to challenge your small dog's mind and reduce boredom.",
    features: ["3 Difficulty Levels", "Non-Slip Base", "Easy to Clean", "Treat Dispensing"],
  },
  {
    id: 4,
    ...
    badge: "Premium",
    category: "Food",
    description: "High-quality, grain-free dry food specially formulated for small breed dogs with sensitive stomachs.",
    features: ["Grain-Free Formula", "Small Kibble Size", "Real Chicken", "Digestive Support"],
  },
  {
    id: 5,
    ...
    badge: "Luxury",
    category: "Beds",
    description: "Orthopedic memory foam bed with removable, washable cover perfect for senior small dogs.",
    features: ["Memory Foam", "Washable Cover", "Non-Slip Bottom", "Orthopedic Support"],
  },
  {
    id: 6,
    ...
    badge: "Bundle",
    category: "Collars",
    description: "Set of 3 stylish collars in different colors and patterns, perfect for fashion-forward small dogs.",
    features: ["3 Different Designs", "Adjustable Size", "Quick Release", "ID Tag Included"],
  },
  {
    id: 7,
    ...
    rating: 4.7,
    reviews: 567,
    image: "/small-dog-grooming-kit.jpg",
    badge: "Professional",
    category: "Grooming",
    description: "Complete grooming kit with nail clippers, brushes, and dental care items for small breeds.",
    features: ["Nail Clippers", "Slicker Brush", "Dental Kit", "Storage Case"],
  },
  {
    id: 8,
    ...
    rating: 4.4,
    reviews: 298,
    image: "/portable-dog-bowls.jpg",
    badge: "Travel",
    category: "Bowls",
    description: "Collapsible silicone bowls perfect for travel and outdoor adventures with your small dog.",
    features: ["Collapsible Design", "Food Grade Silicone", "Carabiner Clip", "Easy to Clean"],
  },
  {
    id: 9,
    ...
    rating: 4.6,
    reviews: 445,
    image: "/small-dog-training-treats.jpg",
    badge: "Training",
    category: "Treats",
    description: "Assorted training treats in small sizes perfect for positive reinforcement training sessions.",
    features: ["3 Flavor Variety", "Small Size", "Natural Ingredients", "Training Guide Included"],
  },
]
